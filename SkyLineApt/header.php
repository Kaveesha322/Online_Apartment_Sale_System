...
<html lang="en">
  <head>
    ...
    <title><?php if (isset($title)) {echo "SkyLine - "; echo $title;} else {echo "SkyLine";} ?></title>
  </head>
  ...
  <body>
    <nav id="nav_bar">
      <div class="nav_container">
        <div class="nav_logo">
          <a href="./index.php"><img src="./images/logo/SK-Apartments.png" alt="Skyline Apartments"></a>
        </div>
        <div class="nav_links">
          <ul>
